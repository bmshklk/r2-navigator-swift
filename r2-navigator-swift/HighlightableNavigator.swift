...
public protocol HighlightableNavigator: SelectableNavigator, VisualNavigator {
    ...
    func rectangleForHighlightWithID(_ id: String, callback: @escaping (CGRect?) -> Void)
    ...
    func rectangleForHighlightAnnotationMarkWithID(_ id: String) -> CGRect?
...
public struct Highlight {
    ...
    public init(id: String, locator: Locator, style: String, color: UIColor? = nil, annotationMarkStyle: String? = nil) {
        self.id = id
